...
<body class='italic text-white font-bold relative'>
   <header class='flex justify-between items-center bg-[#292323] p-5'> 
     ...
     <div class='flex justify-center items-center'>
        <div class='flex relative justify-center rounded-lg items-center text-black  gap-10 border p-7 mt-20 mb-30 shadow-lg'>
            ...
            <div class='flex flex-col gap-5 mt-20 text-2xl'>
                ...
                <form method="POST" action="/cart/add/mac/{{ $macbook->id }}">
                    ...
                    <div class='mt-7  flex  gap-y-10'>
                        ...
                        <button type="submit" class=' transition-colors duration-300  cursor-pointer hover:bg-blue-600 ml-5 bg-black pl-10 pr-10 pt-5 pb-5 rounded-sm text-white'>Add to Cart</button>
                        </div>
                    </div>
                </form>
                @else
